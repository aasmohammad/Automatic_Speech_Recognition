...
% By  Lokesh Chaturvedi, Aas Mohammad, Amit Saini
%--------------------------------------------------------------------------
...
disp('By  Lokesh Chaturvedi & Aas Mohammad & Amit Saini ');
disp(' ');
pause(0.5);
disp('LOADING ');
pause(1);
...
for i = 1:8
    ...
    % Compute MFCC of the audio data to be used in Speech Processing for Train Folder
    ctr{i} = mfcc(str{i},fstr{i});

    % Compute MFCC of the audio data to be used in Speech Processing for Test Folder
...
while ch~=poss
    ...
    ch=menu('Speaker Recognition System','1: Human speaker recognition',...
        ...
        '7: Recognition rate of the computer',...
        '8: Test with other speech files','9: Exit');
    disp('                                                                  ');
    %----------------------------------------------------------------------
...
%%  6: Modified spectrum
    ...
    if ch==7
        disp('> 7: Recognition rate of the computer')
        %----------------------------------------------------------------------

%% 7.1 Loading from Test Folder for Comparison
...
%% 7.2 Comparing one by one data from TRAIN FOLDER
...
%% 7.3 Note: Test with other speech files
...
%% 8: Voice Recognition by letting user enter into database and then compare
    ...
    if ch==8
        disp('> 8: Test with other speech files')
...
%% 8.1 Add a new sound from microphone
...
%% 8.2 Voice Recognition from microphone
